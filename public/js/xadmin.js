;!function (win) {
     ...
     * @return {[type]}        [description]
     */
    Xadmin.prototype.open = function (title, url, w, he, full) {
        if (title == null || title == '') {
            var title = false;
        }
        if (url == null || url == '') {
        ...
        var index = layer.open({
            ...
            success: function (layero, index) {
                ...
                var layui_layer_dom = $("#layui-layer" + layerIndex);
                var layerInitWidth = layui_layer_dom.width();
                var layerInitHeight = layui_layer_dom.height();
    ...
    // 自己写的隐藏左侧菜单的方法
    Xadmin.prototype.hide_side = function () {
