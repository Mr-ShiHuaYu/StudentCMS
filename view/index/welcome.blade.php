            ...
            <div class="layui-col-md3">
                <div class="col-xs-6 col-md-3">
                    <div class="panel layui-bg-cyan" style="background-color:#f35917 !important;">
                        <div class="panel-body" layuimini-content-href="{{url('/user')}}" data-title="学生列表">
            ...
            <div class="layui-col-md3">
                <div class="col-xs-6 col-md-3">
                    <div class="panel layui-bg-blue">
                        <div class="panel-body" layuimini-content-href="{{url('/score')}}" data-title="成绩查询">
            ...
            <div class="layui-col-md3">
                <div class="col-xs-6 col-md-3">
                    <div class="panel layui-bg-green">
                        <div class="panel-body" layuimini-content-href="{{url('/analyze')}}" data-title="总体分析">
                            <div class="panel-content" style="margin: 25px 10px;">
                                <h1 class="no-margins">
            ...
            <div class="layui-col-md3">
                <div class="col-xs-6 col-md-3">
                    <div class="panel layui-bg-orange">
                        <div class="panel-body" layuimini-content-href="{{url('/analyze/gerenfx')}}" data-title="个人分析">
                            <div class="panel-content" style="margin: 25px 10px;">
                                <h1 class="no-margins">
