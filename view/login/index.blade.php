...
<script src="{{asset('static/lib/jquery-3.4.1/jquery-3.4.1.min.js')}}"></script>
<script src="{{asset('static/lib/layui-v2.5.5/layui.all.js')}}" charset="UTF-8"></script>
...
<script src="{{asset('static/js/my.js')}}" charset="UTF-8"></script>
