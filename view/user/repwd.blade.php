    ...
    <form class="layui-form layuimini-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_username" name="username" disabled value="{{session('user.name')}}"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="R_repass" name="newpass_confirm" required=""
    ...
    <script>
        layui.use(['form', 'layer'],
            function () {
                ...
                form.on('submit(save)',
                    function (data) {
                        $.post('{{url('/user/dorepwd')}}', data.field, function (res) {
                            my.msg(res);
